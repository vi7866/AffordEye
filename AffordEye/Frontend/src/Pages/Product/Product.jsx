...
const NewProduct = () => {
  ...
  const fetchproduct = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:5000/product?sort=${sort}&productRefLink=${productRef}&productType=${types}&gender=${gender}&page=${page}&shape=${shape}&style=${style}`
      );
  ...
  useEffect(() => {
    fetchproduct();
  }, [page, sort, gender, types, productRef, shape, style]);
